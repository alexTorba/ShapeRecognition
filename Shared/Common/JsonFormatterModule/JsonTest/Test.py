...
from Shared.Common.JsonFormatterModule.JsonTest.Entities.DerivedClass import DerivedClass
from Shared.Common.JsonFormatterModule.JsonTest.Entities.MyCollection import MyCollection
